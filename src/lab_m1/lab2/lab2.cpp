...
void Lab2::Init()
{
    ...
    vector<VertexFormat> vertices_tetraedru
    {
        ...
        VertexFormat(glm::vec3(0.33f, 0.33f, 0.33f), glm::vec3(1, 0, 0)),
    ...
    vector<VertexFormat> vertices_bonus
    {
        ...
        VertexFormat(glm::vec3(0.33f, 0.33f, 0.33f), glm::vec3(0, 1, 0)),

        VertexFormat(glm::vec3(0, 0, 1), glm::vec3(0, 0, 1)),
        VertexFormat(glm::vec3(0.33f, 0.33f, 0.33f), glm::vec3(0, 0, 1)),
        ...
        VertexFormat(glm::vec3(0.33f, 0.33f, 0.33f), glm::vec3(1, 0, 1)),
    ...
    CreateMesh("bonus", vertices_bonus, indices_bonus);
...
void Lab2::Update(float deltaTimeSeconds)
{
    ...
    RenderMesh(meshes["cube_B"], shaders["VertexColor"], glm::vec3(2, 2, 2), glm::vec3(1));

    // TODO(student): Draw the tetrahedron
    RenderMesh(meshes["tetraedru"], shaders["VertexColor"], glm::vec3(-2, 2, -2), glm::vec3(1));

    // TODO(student): Draw the square

    RenderMesh(meshes["patrat"], shaders["VertexColor"], glm::vec3(-1, 2, -1), glm::vec3(1));

    // TODO(student): Disable face culling
    glDisable(GL_CULL_FACE);

    // Bonus
    RenderMesh(meshes["bonus"], shaders["VertexColor"], glm::vec3(-3, 1, 1), glm::vec3(1));
}
