...
/*
* MAG:
*   GL_LINEAR  : Culorile cubului din stanga se vad ca si cum ar fi blurate, in ceata
*   GL_NEAREST : Se vede si se distinge culoarea fiecarui pixel in parte 
* 
* MIN: 
*   Pentru urmatoarele nu prea mi-am dat seama de nicio diferenta:(
*/
