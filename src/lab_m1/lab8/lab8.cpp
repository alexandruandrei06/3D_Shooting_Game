...
{
    {
        ...
        RenderSimpleMesh(meshes["sphere"], shaders["LabShader"], modelMatrix, glm::vec3(0, 1, 0.145));
...

    {
        ...
        // TODO(student): Add or change the object colors
        RenderSimpleMesh(meshes["box"], shaders["LabShader"], modelMatrix, glm::vec3(0.901, 0, 0.921));
...
void Lab8::OnInputUpdate(float deltaTime, int mods)
{
    ...
    if (!window->MouseHold(GLFW_MOUSE_BUTTON_RIGHT))
    {
        ...
        turn = glm::rotate(turn, angleOY, glm::vec3(0, 1, 0)); //rotire pe OY
        turn = glm::rotate(turn, angleOX, glm::vec3(1, 0, 0)); //rotire pe OX

        //Setare directia initiala a luminii in jos, spre plan
        lightDirection = glm::vec3(0, -1, 0);
